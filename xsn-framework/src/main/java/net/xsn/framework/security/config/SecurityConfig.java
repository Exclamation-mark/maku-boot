package net.xsn.framework.security.config;

import lombok.AllArgsConstructor;
import net.xsn.framework.security.exception.SecurityAuthenticationEntryPoint;
import net.xsn.framework.security.mobile.MobileAuthenticationProvider;

...
ALTER SEQUENCE sys_menu_id_seq RESTART WITH (SELECT MAX(id) + 1 FROM sys_menu);

ALTER SEQUENCE sys_dict_type_id_seq RESTART WITH (SELECT MAX(id) + 1 FROM sys_dict_type);

ALTER SEQUENCE sys_dict_data_id_seq RESTART WITH (SELECT MAX(id) + 1 FROM sys_dict_data);
